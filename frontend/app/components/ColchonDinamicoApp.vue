...
const states = ref({
  bien: {
    ...
    drivers: [
      { label: 'Excedente sostenido', value: '2 meses', color: 'var(--ok)' },
      { label: 'Score X-Ray', value: '78 · sano', color: 'var(--ok)' },
      { label: 'Runway h3', value: '4,8 meses', color: 'var(--ok)' },
      { label: 'Tipo depósito preferente', value: '3,2 %', color: 'var(--text)' }
    ],
  ...
  normal: {
    ...
    drivers: [
      { label: 'Excedente sostenido', value: '< 1 mes', color: 'var(--warn)' },
      { label: 'Score X-Ray', value: '62 · vigilancia', color: 'var(--warn)' },
  ...
  mal: {
    ...
    drivers: [
      { label: 'Runway h3 previsto', value: '1,8 meses', color: 'var(--bad)' },
      { label: 'Score X-Ray', value: '68 · vigilancia', color: 'var(--warn)' },
  ...
  >
    ...
    <div style="flex: 1; display: flex; flex-direction: column; min-width: 0; overflow: hidden;" :style="chrome ? null : { overflow: 'visible' }">
      ...
      <div style="flex: 1; display: flex; flex-direction: column; gap: 18px;" :style="chrome ? { overflowY: 'auto', padding: '26px 32px' } : { padding: '16px 24px 22px' }">
        ...
        >
          <div style="width: 40px; height: 40px; border-radius: var(--r-lg); display: flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0;" :style="{ background: state.iconBg }">{{ state.icon }}</div>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px;">
          ...
          <div class="card" style="padding: 20px 22px;">
            ...
            <div style="height: 32px; margin-top: 10px;">
              <svg width="100%" height="32" viewBox="0 0 200 32" preserveAspectRatio="none"><polyline points="0,26 20,24 40,22 60,18 80,16 100,14 120,14 140,12 160,10 180,8 200,6" fill="none" :stroke="accent" stroke-width="2" stroke-linecap="round"></polyline></svg>
            </div>
          </div>
        ...
        <div style="display: grid; grid-template-columns: 1.6fr 1fr; gap: 16px;">
          ...
          <div class="card" style="padding: 20px 22px;">
            ...
            <svg width="100%" height="220" viewBox="0 0 700 220" preserveAspectRatio="none">
              ...
              <polyline :points="state.chartHistory" fill="none" :stroke="state.color" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></polyline>
              <polyline :points="state.chartForecast" fill="none" :stroke="state.color" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="5,5" opacity="0.7"></polyline>
              <circle :cx="state.chartLastX" :cy="state.chartLastY" r="5" :fill="state.color" stroke="var(--card)" stroke-width="2"></circle>
            </svg>
        ...
        <div class="card" style="padding: 18px 22px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
            ...
            <span style="font-size: 12px; font-weight: 600; cursor: pointer;" :style="{ color: accent }">Ver todo →</span>
          </div>
