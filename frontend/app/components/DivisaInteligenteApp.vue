...
const states = ref({
  bien: {
    ...
    upcomingPayments: [
      { amount: '45.000 USD', date: '15 nov', counterparty: 'Global Supplies Inc.', status: 'Cubrir hoy · ahorra 900€', bg: 'var(--ok-bg)', border: 'var(--ok-border)', statusBg: '#D0EFDD', statusText: '#17805A' },
      { amount: '18.500 GBP', date: '22 nov', counterparty: 'London Freight Ltd.', status: 'Cubrir esta semana', bg: 'var(--card)', border: 'var(--border)', statusBg: 'var(--warn-bg)', statusText: '#8A6410' },
      { amount: '620.000 JPY', date: '01 dic', counterparty: 'Sakura Materials', status: 'Sin urgencia', bg: 'var(--card)', border: 'var(--border)', statusBg: '#EEF0F7', statusText: 'var(--text-2)' }
    ],
    history: [
      { date: '05 sep', title: 'Cobertura 32k USD · ahorro 640 €', desc: 'Ejecutada 8 días antes del pago · tipo 0,915', badge: 'Cerrada', badgeBg: 'var(--ok-bg)', badgeText: '#17805A' },
      { date: '22 ago', title: 'Cobertura 15k GBP · ahorro 320 €', desc: 'Modo auto activado por < 20k€', badge: 'Cerrada', badgeBg: 'var(--ok-bg)', badgeText: '#17805A' },
      { date: '10 ago', title: 'Cobertura 60k USD · ahorro 1.240 €', desc: 'Trimestre anterior · efecto acumulado', badge: 'Cerrada', badgeBg: '#EEF0F7', badgeText: 'var(--text-2)' }
    ]
  },
  normal: {
    ...
    upcomingPayments: [
      { amount: '4.200 USD', date: '18 nov', counterparty: 'US Design Studio', status: 'Sin urgencia', bg: 'var(--card)', border: 'var(--border)', statusBg: '#EEF0F7', statusText: 'var(--text-2)' },
      { amount: '3.800 GBP', date: '01 dic', counterparty: 'Small Vendor UK', status: 'Sin urgencia', bg: 'var(--card)', border: 'var(--border)', statusBg: '#EEF0F7', statusText: 'var(--text-2)' },
      { amount: '1.100 USD', date: '05 dic', counterparty: 'SaaS License', status: 'Sin urgencia', bg: 'var(--card)', border: 'var(--border)', statusBg: '#EEF0F7', statusText: 'var(--text-2)' }
    ],
    history: [
      { date: '02 sep', title: 'Pago a tipo spot · 3.400 USD', desc: 'Sin cobertura · por debajo del umbral', badge: 'Sin acción', badgeBg: '#EEF0F7', badgeText: 'var(--text-2)' },
      { date: '25 ago', title: 'Pago a tipo spot · 5.100 USD', desc: 'Sin cobertura · por debajo del umbral', badge: 'Sin acción', badgeBg: '#EEF0F7', badgeText: 'var(--text-2)' },
      { date: '10 ago', title: 'Cobertura 22k USD · ahorro 380 €', desc: 'Última cobertura del ciclo', badge: 'Cerrada', badgeBg: '#EEF0F7', badgeText: 'var(--text-2)' }
    ]
  },
  mal: {
    ...
    upcomingPayments: [
      { amount: '45.000 USD', date: '12 nov · cancelado en ERP', counterparty: 'Global Supplies Inc.', status: 'Posición abierta', bg: 'var(--bad-bg)', border: 'var(--bad-border)', statusBg: '#F7CFCC', statusText: '#B0322A' },
      { amount: '18.500 GBP', date: '22 nov', counterparty: 'London Freight Ltd.', status: 'Verificando', bg: 'var(--warn-bg)', border: 'var(--warn-border)', statusBg: '#F5E4B8', statusText: '#8A6410' },
      { amount: '620.000 JPY', date: '01 dic', counterparty: 'Sakura Materials', status: 'Sin urgencia', bg: 'var(--card)', border: 'var(--border)', statusBg: '#EEF0F7', statusText: 'var(--text-2)' }
    ],
    history: [
      { date: '13 nov', title: '🔴 Posición huérfana detectada', desc: 'Pago cancelado en ERP tras hedge · aviso al CFO', badge: 'Activa', badgeBg: 'var(--bad-bg)', badgeText: '#B0322A' },
      { date: '10 nov', title: 'Cobertura 45k USD ejecutada', desc: 'Ahorro esperado 900 € · antes de la cancelación', badge: 'Sin uso', badgeBg: 'var(--warn-bg)', badgeText: '#8A6410' },
      { date: '02 nov', title: 'Cobertura 22k USD · ahorro 360 €', desc: 'Ejecutada y utilizada correctamente', badge: 'Cerrada', badgeBg: '#EEF0F7', badgeText: 'var(--text-2)' }
    ]
  }
})
      ...
      <div style="flex: 1; display: flex; flex-direction: column; gap: 18px;" :style="chrome ? { overflowY: 'auto', padding: '26px 32px' } : { padding: '16px 24px 22px' }">
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-end;">
          <div>
            ...
            <p style="margin: 0; font-size: 13.5px; color: #6B7089;">Predice tus pagos en divisa y cubre al mejor tipo antes de la fecha del cobro o pago.</p>
          </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px;">
          ...
          <div class="card" style="padding: 20px 22px;">
            <div style="display: flex; justify-content: space-between; align-items: baseline;">
              <span style="font-size: 12.5px; color: #6B7089;">Exposición FX · próximo trimestre</span>
          ...
          <div class="card" style="padding: 20px 22px;">
            <div style="display: flex; justify-content: space-between; align-items: baseline;">
              <span style="font-size: 12.5px; color: #6B7089;">Cobertura actual</span>
          ...
          <div style="border-radius: var(--r-lg); padding: 20px 22px;" :style="{ background: state.heroBg, border: `1px solid ${state.heroBorder}` }">
            <div style="display: flex; justify-content: space-between; align-items: baseline;">
              <span style="font-size: 12.5px; color: #6B7089;">{{ state.savingsLabel }}</span>
        ...
        <div style="display: grid; grid-template-columns: 1.6fr 1fr; gap: 16px;">
          ...
          <div class="card" style="padding: 20px 22px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
              ...
              <span style="padding: 4px 10px; background: #EEF0F7; color: var(--text-2); border-radius: 6px; font-size: 11.5px; font-weight: 600;">EUR / USD</span>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
              ...
              >
                <div style="display: flex; justify-content: space-between; align-items: baseline;">
                  ...
                  <span style="font-size: 11.5px; color: #6B7089;">{{ pay.date }}</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  <span style="font-size: 11.5px; color: #6B7089;">{{ pay.counterparty }}</span>
