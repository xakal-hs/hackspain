...
|---|---|---|---|
| 1 | `./run.sh fase1` | 4 `researcher` en paralelo (datos y caja · features y eventos · modelo y servicio · documentación y entornos). El orquestador escribe el mapa y el plan por paquetes, y un `reviewer` lo critica | No: solo escribe en `salida/`, y `run.sh` comprueba que no tocó nada más |
